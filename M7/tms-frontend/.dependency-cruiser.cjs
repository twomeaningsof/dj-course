...
module.exports = {
  forbidden: [
    ...
    {
      "name": "no-components-in-http",
      "comment": "Nie importuj komponentów UI do warstwy komunikacji HTTP (zapobieganie wyciekowi widoku do logiki)",
      "severity": "error",
      "from": { "path": "^src/http" },
...
// generated: dependency-cruiser@17.3.6 on 2026-01-05T03:38:22.834Z
